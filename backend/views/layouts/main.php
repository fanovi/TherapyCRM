...
$menuItems = [
    ...
    // Gestione Ruoli, Permessi Utente, Gestione Permessi - spostati nel frontend
    [
    ...
    [
        ...
        'url' => ['/system-setting/calendar'],
        'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />',
        'routes' => ['system-setting/calendar', 'system-setting/update-calendar'],
    ],
    [
        'label' => 'Esporta Permessi',
        'url' => ['/export-permissions/index'],
        ...
        'routes' => ['export-permissions/index'],
    ],
];
?>
<?php $this->beginPage() ?>

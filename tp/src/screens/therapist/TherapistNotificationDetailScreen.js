...
const TherapistNotificationDetailScreen = () => {
  ...
  const fetchNotificationDetail = async () => {
    try {
      setLoading(true);
      console.log(
        '🩺 TherapistNotificationDetail: Recupero dettaglio notifica...',
      );

      const response = await getNotificationDetail(notificationId);
      console.log(
        '🩺 TherapistNotificationDetail: Risposta ricevuta:',
        response,
      );
      ...
      if (response.success && response.data) {
        ...
        console.warn(
          '🩺 TherapistNotificationDetail: Risposta non valida:',
          response,
        );
        Alert.alert(
          'Errore',
      ...
      console.error(
        '❌ TherapistNotificationDetail: Errore recupero dettaglio:',
        error,
      );
            ...
            <View style={styles.metadataContainer}>
              ...
              {notification.scheduled_for && (
                <View style={styles.metadataRow}>
                  ...
                  />
                  <Text variant="bodySmall" style={styles.metadataText}>
                    Programmata per: {formatDate(notification.scheduled_for)}
                  </Text>
                </View>
              )}
            </View>
...
export default TherapistNotificationDetailScreen;

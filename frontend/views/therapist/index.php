    ...
    <div id="notification-actions-bar" class="hidden items-center justify-between mb-4 p-4 bg-gray-50 border border-gray-200 rounded-2xl dark:bg-white/[0.03] dark:border-gray-800">
        <div class="flex items-center">
            ...
            <span class="text-gray-800 dark:text-white/90 font-medium">
                <span id="selected-therapists-count">0</span> terapisti selezionati
            </span>
        </div>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Gestisci i terapisti del sistema. Seleziona i terapisti per inviare notifiche.
                    </p>
                </div>
                <div class="flex items-center">
                    <input type="checkbox" id="select-all-therapists"
                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    <label for="select-all-therapists" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                        Seleziona tutto
                    </label>
                </div>
            </div>
        ...
        <div class="border-t border-gray-100 dark:border-gray-800 overflow-x-auto">
            ...
            <?= GridView::widget(array_merge([
                ...
                'columns' => [
                    // Colonna checkbox per selezione invio notifiche
                    [
                        'headerOptions' => ['class' => 'px-4 py-3 w-12'],
                        'contentOptions' => ['class' => 'px-4 py-4'],
                        'filter' => false,
                        'header' => '',
                        'content' => function ($model) {
                            return Html::checkbox('therapist_ids[]', false, [
                                'value' => $model->id,
                                'class' => 'therapist-checkbox h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded'
                            ]);
                        },
                    ],
                    [
                    ...
                    [
                        ...
                        'buttons' => [
                            ...
                            'reset-password' => function ($url, $model, $key) {
                                ...
                                return Html::button('<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>', [
...
>
    ...
    <div
        ...
        x-data="{
            ...
            resetMessages() { this.errors = ''; this.success = ''; }
        }"
        ...
        <div class="flex flex-col px-2 overflow-y-auto modal-content custom-scrollbar">
            <div class="modal-header">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h5 class="font-semibold text-gray-800 modal-title text-theme-xl dark:text-white/90 lg:text-2xl">
                        Invia Notifica
                    </h5>
                </div>
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Invia una notifica informativa agli account dei terapisti selezionati
                </p>
            </div>
            ...
            <div class="mt-6 modal-body">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="text-sm">
                            <p class="font-medium text-brand-800 dark:text-brand-200">
                                <span x-text="selectedCount"></span> terapisti selezionati
                            </p>
                            <p class="mt-1 text-brand-700 dark:text-brand-300">
                                La notifica sarà inviata agli account dei terapisti selezionati
                            </p>
                ...
                <div>
                    <div class="mb-6">
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Titolo Notifica *</label>
                        <input x-ref="titleInput" x-model="title" type="text"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                            placeholder="Inserisci il titolo della notifica..." maxlength="100" required />
                    </div>

                    <div class="mb-6">
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Messaggio *</label>
                        <textarea x-model="message" rows="4"
                            class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                            placeholder="Inserisci il messaggio della notifica..." maxlength="500" required></textarea>
                    </div>

                    <div class="mb-6">
                        <div class="flex items-center">
                            <input type="checkbox" id="requires-read-confirmation"
                                class="h-4 w-4 text-brand-600 focus:ring-brand-500 border-gray-300 rounded" />
                            <label for="requires-read-confirmation" class="ml-2 block text-sm font-medium text-gray-700 dark:text-gray-400">
            ...
            <div class="flex items-center gap-3 mt-6 modal-footer sm:justify-end">
                ...
                <button type="button" id="send-notification-modal-btn"
                    :disabled="isLoading || !title.trim() || !message.trim()"
                    @click="window.sendTherapistNotifications()"

...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white shadow-lg dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <!-- Informazioni su cosa accade dopo la sottomissione -->
        <div class="bg-amber-50 border border-amber-200 p-4 rounded-lg dark:bg-amber-900/20 dark:border-amber-800">
            <div class="flex">
                <div class="flex-shrink-0">
                ...
                <div class="ml-3 flex-1">
                    ...
                    <div class="text-sm text-amber-700 dark:text-amber-300 space-y-1">
                        <p>• La password verrà modificata <strong>immediatamente</strong> dopo la conferma</p>
                        <p>• Verrai <strong>automaticamente riautenticato</strong> nella sessione corrente</p>
                        <p>• Per i prossimi accessi dovrai utilizzare la <strong>nuova password</strong></p>
                        <p>• Se hai altre sessioni aperte (app mobile, altri browser), dovrai effettuare nuovamente il login con la nuova password</p>
                    </div>
                </div>
            </div>
        </div>

                ...
                <div
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                type="url"
                                placeholder="www.sanlucacentromedico.it"
                    ...
                    <div id="copy-input">
                        ...
                        <div class="relative">
                            ...
                            <input
                                value="www.sanlucacentromedico.it"
                                type="url"
                                id="website-input"
                        ...
                        <div x-data="{ switcherToggle: false }">
                            <label
                                ...
                                <div class="relative">
                                    ...
                                    <div
                                        class="block h-6 w-11 rounded-full"
                                        :class="switcherToggle ? 'bg-brand-500 dark:bg-brand-500' : 'bg-gray-100 dark:bg-gray-800'"></div>
                                    <div
                                        :class="switcherToggle ? 'translate-x-full': 'translate-x-0'"

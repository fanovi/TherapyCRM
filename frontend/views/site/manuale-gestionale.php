    ...
    <aside class="hidden xl:block w-56 flex-shrink-0">
        <div class="sticky top-24">
            ...
            <nav class="space-y-0.5 max-h-[calc(100vh-10rem)] overflow-y-auto pr-2">
                ...
                <a class="toc-link" @click="openSection='permessi'; $nextTick(() => $refs.permessi.scrollIntoView({behavior:'smooth', block:'start'}))" :class="openSection==='permessi' && 'text-blue-500 font-medium'">15. Gestione Permessi</a>

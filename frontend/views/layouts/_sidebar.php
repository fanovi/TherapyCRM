...
<?php endif; ?>
                    ...
                    <!-- Menu Item Manuale d'Uso -->
                    <li>
                        <a
                            href="<?= \yii\helpers\Url::to(['/site/manuale']) ?>"
                            class="menu-item group <?= isMenuActive('Manuale', $currentRoute, $menuMappings) ? 'menu-item-active' : 'menu-item-inactive' ?>">
                            <svg
                            ...
                            <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">Manuale d'Uso</span>
                        </a>
                    </li>

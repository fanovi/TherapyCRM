...
<div class="notification-item <?= $isUnread ? 'unread' : 'read' ?>" data-id="<?= $model->id ?>">
    <div class="rounded-xl border p-4 sm:p-6 hover:shadow-md transition-all duration-200 <?= $isUnread ? 'border-orange-200 dark:border-orange-800' : 'bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800' ?>" 
         style="<?= $isUnread ? 'background-color: var(--color-brand-50);' : '' ?>">
        <div class="flex items-start space-x-4">
            <!-- Indicatore visivo e icona -->
            <div class="flex-shrink-0 relative">
                <?php if ($isUnread): ?>
                    <div class="absolute -top-1 -left-1 w-3 h-3 bg-orange-500 rounded-full animate-pulse"></div>
                <?php endif; ?>
                ...
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-center gap-2 mb-2">
                            ...
                            <!-- Badge stato lettura -->
                            <?php if ($isUnread): ?>
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-orange-200 text-orange-900 dark:bg-orange-800 dark:text-orange-100">
                                    ● Non letta
                                </span>
                            <?php else: ?>
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-200 text-green-900 dark:bg-green-800 dark:text-green-100">
                                    ✓ Letta
                                </span>
                            <?php endif; ?>
                        ...
                        <div class="flex flex-wrap items-center gap-3 text-xs text-gray-500 dark:text-gray-400">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <span>Da: <?= $model->senderUser ? Html::encode($model->senderUser->username) : 'Sistema' ?></span>
                            </div>
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <span>A: <?= $model->recipientUser ? Html::encode($model->recipientUser->username) : 'Utente' ?></span>
                            </div>
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <span>Creata: <?= Yii::$app->formatter->asRelativeTime($model->created_at) ?></span>
                            </div>
                            ...
                            <?php if ($model->isSent()): ?>
                                <div class="flex items-center gap-1 text-blue-600 dark:text-blue-400">
                                    ...
                                    <span>Inviata: <?= Yii::$app->formatter->asRelativeTime($model->sent_at) ?></span>
                                </div>
                            <?php endif; ?>
                    ...
                    <div class="flex items-center gap-2 flex-shrink-0">
                        <?= Html::a('Dettagli', ['notification/view', 'id' => $model->id], [

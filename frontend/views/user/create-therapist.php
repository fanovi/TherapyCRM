...
/** @var common\models\UserProfile $profileModel */
/** @var common\models\Therapist $therapistModel */

$this->title = 'Nuovo Terapista';
$this->params['breadcrumbs'][] = 'Terapisti';
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="px-5 py-4 sm:px-6 sm:py-5">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Inserisci i dati per creare un nuovo terapista con le sue specializzazioni.
            </p>
        </div>
        ...
        <div class="border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <!-- Nome -->
                <div>
                    <?= $form->field($profileModel, 'nome')->textInput([
                ...
                <!-- Cognome -->
                <div>
                    <?= $form->field($profileModel, 'cognome')->textInput([
                        'class' => 'dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30',
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <!-- Telefono -->
                <div>
                    <?= $form->field($profileModel, 'telefono')->textInput([
                        'class' => 'dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30',
            ...
            <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-900/50">
                <h4 class="text-sm font-medium text-gray-800 dark:text-white/90 mb-4">Dati Professionali</h4>
                
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <!-- Specializzazione -->
                    <div>
                        <?= $form->field($therapistModel, 'specialization_id')->dropDownList(
                    ...
                    <!-- Numero Albo -->
                    <div>
                        <?= $form->field($therapistModel, 'numero_albo')->textInput([
                            'class' => 'dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30',
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 mt-6">
                    <!-- Data Assunzione -->
                    <div>
                        <?= $form->field($therapistModel, 'data_assunzione')->textInput([
                            'class' => 'dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30',
                            'type' => 'date'
                    ...
                    <!-- Ore Settimanali -->
                    <div>
                        <?= $form->field($therapistModel, 'ore_settimanali')->textInput([
                            'class' => 'dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30',
                            'type' => 'number',
                            'min' => '1',
                            'max' => '40',
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <!-- Data di nascita -->
                <div>
                    <?= $form->field($profileModel, 'data_nascita')->textInput([
                        'class' => 'dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30',
                        'type' => 'date'
                ...
                <!-- Sesso -->
                <div>
                    <?= $form->field($profileModel, 'sesso')->dropDownList([
                        'M' => 'Maschio',
                        'F' => 'Femmina'
                    ], [
            ...
            <!-- Indirizzo -->
            <div>
                <?= $form->field($profileModel, 'indirizzo')->textInput([
                    'class' => 'dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30',
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                <!-- Città -->
                <div>
                    <?= $form->field($profileModel, 'citta')->textInput([
                        'class' => 'dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30',
                        'placeholder' => 'Roma'
                    ])->label('Città', [
                        'class' => 'block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1.5'
                ...
                <!-- CAP -->
                <div>
                    <?= $form->field($profileModel, 'cap')->textInput([
                        'class' => 'dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30',
                        'placeholder' => '00100'
                    ])->label('CAP', [
                        'class' => 'block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1.5'
                ...
                <!-- Distretto -->
                <div>
                    <?= $form->field($profileModel, 'district_id')->dropDownList(
            ...
            <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-100 dark:border-gray-800">
                <?= Html::a('Annulla', ['/user/therapists'], [

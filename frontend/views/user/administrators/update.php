...
$this->title = 'Modifica Amministratore: ' . ($user->profile ? $user->profile->first_name . ' ' . $user->profile->last_name : $user->username);
$this->params['breadcrumbs'][] = ['label' => 'Amministratori', 'url' => ['administrators']];
$this->params['breadcrumbs'][] = ['label' => ($user->profile ? $user->profile->first_name . ' ' . $user->profile->last_name : $user->username), 'url' => ['view-administrator', 'id' => $user->id]];
        ...
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
            ...
            <nav>
                <ol class="flex items-center gap-1.5">
                    ...
                    <li>
                        <a class="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400" href="<?= \yii\helpers\Url::to(['/user/view-administrator', 'id' => $user->id]) ?>">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="px-5 py-4 sm:px-6 sm:py-5">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Aggiorna le informazioni dell'amministratore.
            </p>
        </div>
        ...
        <div class="border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
            ...
            <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-100 dark:border-gray-800">
                <?= Html::a('Annulla', ['view-administrator', 'id' => $user->id], [
                ...
                <?= Html::submitButton('Aggiorna Amministratore', [

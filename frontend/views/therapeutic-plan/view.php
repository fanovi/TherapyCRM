...
<div class="mx-auto max-w-4xl p-4 md:p-6">
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <div class="flex flex-wrap items-center gap-3">
            <?php if ($model->patient_id && (Yii::$app->user->can('view_calendar') || Yii::$app->user->can('manage_calendar'))): ?>
                <?= Html::a(
                    '<svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>Vai al Calendario',
                    ['/calendar/' . $model->patient_id],
                    [
                        ...
                        'title' => 'Apri il calendario per creare appuntamenti' . ($model->patient ? ' per ' . $model->patient->fullName : ''),
                    ]
                ) ?>
            <?php endif; ?>

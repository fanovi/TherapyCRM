        ...
        <div class="px-5 pb-5 sm:px-6 sm:pb-6">
            ...
            $this->registerJs("
                ...
                document.getElementById('therapeutic-plan-form').addEventListener('submit', function(e) {
                    ...
                    // Nota: il pulsante viene disabilitato in beforeSubmit (dopo validazione Yii client-side)
                    // per evitare di bloccarlo quando la validazione fallisce e il submit non parte.
                });
            ");
            ?>
        </div>
        ...
        if (newStatus === 'terminated' && originalStatus !== 'terminated' && !\$form.data('terminate-confirmed')) {
            ...
            Swal.fire({
                ...
                html: '<div style="text-align:left;font-size:14px;">' +
                      ...
                      '<li>' + termLine + '</li>' +
                      '<li>Gli appuntamenti gi&agrave; svolti, mancati o quelli antecedenti alla data di interruzione verranno <strong>mantenuti</strong></li>' +
                      '<li>Il piano diventer&agrave; <strong>non pi&ugrave; modificabile</strong></li>' +
                      '</ul></div>',
                icon: 'warning',

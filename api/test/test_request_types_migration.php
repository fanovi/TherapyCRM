...
try {
    ...
    $expectedColumns = [
        ...
        'require_therapy_assignment', 'require_notes', 'is_active', 'created_at', 'updated_at'
    ];
    ...
    foreach ($requestTypes as $type) {
        ...
        echo "Attivo: " . ($type->isActive() ? 'Sì' : 'No') . "\n";
        echo "---\n";
    }
    ...
    $activeTypes = RequestType::find()->active()->all();
    echo "Tipi attivi: " . count($activeTypes) . "\n";
    
    $activeTypesStatic = RequestType::findActive()->all();
    echo "Tipi attivi (metodo statico): " . count($activeTypesStatic) . "\n";
